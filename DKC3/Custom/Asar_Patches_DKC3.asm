...
; Note: Put your custom routine/data macros, references to them, and defines in this file from within the DKC3_InsertIntegratedPatches and DKC3_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro DKC3_InsertIntegratedPatches()
...
macro DKC3_ApplyPatchesPostAssembly()
...
macro DKC3_HandleDefaultPatches()
